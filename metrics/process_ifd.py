...
def parse_args():
    ...
    parser.add_argument("--pt_data_path", type=str, default='_data/10k_version/IFD/wiz_10k.jsonl')
    parser.add_argument("--json_data_path", type=str, default='_data/10k_version/wiz_10k.json')
    parser.add_argument("--json_save_path", type=str, default='_data/10k_version/wiz_10k.json')
...
def main():
    ...
    for i in tqdm(range(len(pt_data))):
        ...
        # json_data_i['ppl(response)'] = ppl_A_direct
        json_data_i['ppl_gpt2'] = ppl_A_condition
        try:
            json_data_i['ifd_gpt2'] = ppl_A_condition/ppl_A_direct
        except ZeroDivisionError:
            json_data_i['ifd_gpt2'] = np.nan
